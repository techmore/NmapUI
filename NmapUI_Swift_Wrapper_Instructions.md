...
Use [NmapUIMenuBarLauncher.swift](/Users/seandolbec/Projects/NmapUI/NmapUIMenuBarLauncher.swift) as the only supported source file. It launches the bundled `run.sh` helper and opens `http://127.0.0.1:9000`.
...
Modify this line in [NmapUIMenuBarLauncher.swift](/Users/seandolbec/Projects/NmapUI/NmapUIMenuBarLauncher.swift):
