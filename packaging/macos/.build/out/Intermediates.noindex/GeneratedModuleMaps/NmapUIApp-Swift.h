...
// Generated by Apple Swift version 6.4 (swiftlang-6.4.0.20.104 clang-2100.3.20.102)
#ifndef NMAPUIAPP_SWIFT_H
#define NMAPUIAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="NmapUIApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9NmapUIApp11AppDelegate")
